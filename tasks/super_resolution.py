# This code was modified from: https://github.com/assafshocher/resizer by Assaf Shocher
...
class SuperResolution(NonLinearOperator):
    def __init__(self, resolution, scale_factor, device='cuda'):
        super().__init__()
