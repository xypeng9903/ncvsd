...
config_presets = {
    'edm2-ffhq256-xs':     dnnlib.EasyDict(duration=16<<20, batch=256, channels=128, lr=0.0012, decay=35000, dropout=0.00, P_mean=-0.8, P_std=1.6),
    'edm2-ffhq256-s':      dnnlib.EasyDict(duration=16<<20, batch=256, channels=192, lr=0.0010, decay=35000, dropout=0.00, P_mean=-0.8, P_std=1.6),
}
